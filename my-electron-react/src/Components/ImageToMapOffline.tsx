...
import MapOverlay, { type DEMInfo, type MapOverlayHandle } from "./MapOverlay";
...
export default function ImageToMapOffline() {
    const mapRef = useRef<MapOverlayHandle | null>(null);
    ...
    function onLocate() {
        ...
        if (imageUrl && dem) mapRef.current.setImageOverlay(imageUrl, dem);
    }
        ...
        <div className="mp-layout">
            <div className="mp-left">
                ...
                <div className="card">
                    ...
                    <button className="primary" disabled={!canLocate} onClick={onLocate}>📍 Locate on Map</button>
                </div>
            </div>

            <div className="mp-right">
                <MapOverlay ref={mapRef} className="mp-map" />
            </div>
        </div>
    );
}
